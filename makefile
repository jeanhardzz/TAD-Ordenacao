...
TARGET=src/Bolha/bolha.cpp src/Selecao/selecao.cpp src/Insercao/insercao.cpp src/Quicksort/quicksort.cpp src/tipoitem.cpp src/Quicksort/Pilhas/pilha-arranjo.cpp src/Heapsort/heapsort.cpp main.cpp
